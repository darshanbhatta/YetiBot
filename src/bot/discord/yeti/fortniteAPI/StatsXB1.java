...
public class StatsXB1 {
    ...
    public String lifeWins(){

        return ""+(int)(br_placetop1_xb1_m0_p2+br_placetop1_xb1_m0_p9+br_placetop1_xb1_m0_p10);
    }
    public String life1053(){

        return ""+(int)(br_placetop10_xb1_m0_p2+br_placetop5_xb1_m0_p10+br_placetop3_xb1_m0_p9);
    }
    public String life25126(){

        return ""+(int)(br_placetop25_xb1_m0_p2+br_placetop12_xb1_m0_p10+br_placetop6_xb1_m0_p9);
    }
    public String lifeKills(){

        return ""+(int)(br_kills_xb1_m0_p2+br_kills_xb1_m0_p9+br_kills_xb1_m0_p10);
    }
    public String lifekd(){

        return ""+Math.round(kd_xb1_all * 100.0) / 100.0 ;
    }
    public String lifekMatch(){

        return ""+ Math.round(km_xb1_all * 100.0) / 100.0;
    }
    public String lifeMatch(){

        return ""+(int)(br_matchesplayed_xb1_m0_p2+br_matchesplayed_xb1_m0_p9+br_matchesplayed_xb1_m0_p10) ;
    }
    public String lifewinPercent(){

        return ""+Math.round(wp_xb1_all*100 * 100.0) / 100.0 ;
    }

    public String soloWins(){

        return ""+(int)(br_placetop1_xb1_m0_p2);
    }
    public String solo10(){

        return ""+(int)(br_placetop10_xb1_m0_p2);
    }
    public String solo25(){

        return ""+(int)(br_placetop25_xb1_m0_p2);
    }
    public String soloKills(){

        return ""+(int)(br_kills_xb1_m0_p2);
    }
    public String solokd(){

        return ""+Math.round(kd_xb1_p2 * 100.0) / 100.0 ;
    }
    public String solokMatch(){

        return ""+ Math.round(km_xb1_p2 * 100.0) / 100.0;
    }
    public String soloMatch(){

        return ""+(int)(br_matchesplayed_xb1_m0_p2) ;
    }
    public String solowinPercent(){

        return ""+Math.round(wp_xb1_p2*100 * 100.0) / 100.0 ;
    }


    public String duoWins(){

        return ""+(int)(br_placetop1_xb1_m0_p10);
    }
    public String duo5(){

        return ""+(int)(br_placetop5_xb1_m0_p10);
    }
    public String duo12(){

        return ""+(int)(br_placetop12_xb1_m0_p10);
    }
    public String duoKills(){

        return ""+(int)(br_kills_xb1_m0_p10);
    }
    public String duokd(){

        return ""+Math.round(kd_xb1_p10 * 100.0) / 100.0;
    }
    public String duokMatch(){

        return ""+ Math.round(km_xb1_p10 * 100.0) / 100.0;
    }
    public String duoMatch(){

        return ""+(int)(br_matchesplayed_xb1_m0_p10) ;
    }
    public String duowinPercent(){

        return ""+Math.round(wp_xb1_p10*100 * 100.0) / 100.0;
    }


    public String squadWins(){

        return ""+(int)(br_placetop1_xb1_m0_p9);
    }
    public String squad3(){

        return ""+(int)(br_placetop3_xb1_m0_p9);
    }
    public String squad6(){

        return ""+(int)(br_placetop6_xb1_m0_p9);
    }
    public String squadKills(){

        return ""+(int)(br_kills_xb1_m0_p9);
    }
    public String squadkd(){

        return ""+Math.round(kd_xb1_p9 * 100.0) / 100.0 ;
    }
    public String squadkMatch(){

        return ""+ Math.round(km_xb1_p9 * 100.0) / 100.0;
    }
    public String squadMatch(){

        return ""+(int)(br_matchesplayed_xb1_m0_p9) ;
    }
    public String squadwinPercent(){

        return ""+Math.round(wp_xb1_p9*100 * 100.0) / 100.0 ;
    }
